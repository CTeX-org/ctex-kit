...
> 2026 年 7 月 21 日修正：四种设置现在分别启动 XeLaTeX 编译；每张图片
> 完整显示四种周边文字和两个 `xCJKecglue` 值。旧表把四种设置放在同一次
> 编译中，结果会互相影响，相关统计已重新计算。

- 每格依次表示源码空格 `00`、`10`、`01`、`11`；第一位是命令左侧，第二位是右侧，`1` 表示有空格。
- 每个编号分为 `xCJKecglue=false`、`true` 两行；命令包裹后的写法和直接输入使用相同的选项值。
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `\(x\)` | false | `✅❌✅❌` | `✅✅✅✅` | `✅❌✅❌` | `✅✅✅✅` | [完整测试](https://github.com/CTeX-org/ctex-kit/tree/gh-assets/issues/1002) | <img src="https://raw.githubusercontent.com/CTeX-org/ctex-kit/gh-assets/issues/1002/showcase/paren.png" width="300" alt="括号形式行内公式的间距对照"> | 中文位于公式左侧且左侧有源码空格时，与 `$x$` 相差 3.33pt。 |
| 1 | `\(x\)` | true | `✅❌✅❌` | `✅✅✅✅` | `✅❌✅❌` | `✅✅✅✅` | 同上 | 同上 | 同上 |
...
| 9 | `\mbox{$x$}` | true | `✅✅✅✅` | `✅✅✅✅` | `✅✅✅✅` | `✅✅❌❌` | 同上 | 同上 | 中文位于公式右侧且右侧有源码空格时，与直接输入 `$x$` 相差 1.67pt。 |
...
| 10 | `\makebox{$x$}` | true | `✅✅✅✅` | `✅✅✅✅` | `✅✅✅✅` | `✅✅❌❌` | 同上 | 同上 | 结果与 `\mbox{$x$}` 相同。 |
...
| 11 | `\fbox{$x$}` | true | `❌❌❌❌` | `✅✅✅✅` | `✅✅❌❌` | `✅❌❌✅` | 同上 | 同上 | 两个混合方向分别显示公式左右两侧的差异。 |
...
| 16 | `\hyperref[...]{$x$}` | true | `✅✅✅✅` | `✅✅✅✅` | `✅✅✅✅` | `✅✅❌❌` | 同上 | 同上 | 中文位于公式右侧且右侧有源码空格时，与直接输入不同。 |
...
| 17 | `\href{...}{$x$}` | true | `✅✅✅✅` | `✅✅✅✅` | `✅✅✅✅` | `✅✅❌❌` | 同上 | 同上 | 结果与 `\hyperref` 相同。 |
...
完整测试共有 17 种命令、四种周边文字组合、四种源码空格、两个 `xCJKecglue` 值，再分别使用默认间距和 5pt/1pt 间距，共 1088 次比较。按“两个间距设置都通过才记 ✅”的规则，本表共有 544 格，其中 333 格通过、211 格不同。

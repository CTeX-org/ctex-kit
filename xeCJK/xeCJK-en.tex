...
The \expstar{} after some option or command means that
this option or command can only be used in the preamble. Symbol \rexpstar{}
...
\begin{function}[rEXP]{AutoFakeBold}
  ...
  whether or not
  \textbf{\addfontfeatures{AutoFakeBold}fake bold} should
...
\begin{function}[rEXP]{AutoFakeSlant}
  ...
  \textit{\addfontfeatures{AutoFakeSlant}fake slant} should

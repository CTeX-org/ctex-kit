...
%
\documentclass[GBK, cs4size, a4paper]{ctexart}
\usepackage{hyperref}
\usepackage{fancyhdr}
\IfFileExists{ccmap.sty}{\usepackage{ccmap}}{}
...
This LaTeX manuscript should be saved as GBK encoding, and be compiled by
...
and/or LuaLaTeX on Mac OS X (and UTF-8 encoding, of course). 
Otherwise, you will have to choose a fontset manually.

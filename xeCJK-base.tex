...
% XeTeX 0.99994 将字符类总数扩大到4096
\ifnum\strcmp{\the\XeTeXversion\XeTeXrevision}{0.99993}>0
  \mathchardef\xecjk@boundry=4095
\else
  \chardef\xecjk@boundry=255
\fi
...
\def\xeCJK@setpunctcharclass{
  ...
  \xeCJK@postPunct{20}{13,19,1D,14,26}
...
\XeTeXinterchartoks 1 \xecjk@boundry{\xeCJK@i@cclv}
...
\XeTeXinterchartoks 2 \xecjk@boundry{\xeCJK@ii@cclv}
...
\XeTeXinterchartoks 3 \xecjk@boundry{\xeCJK@iii@cclv}
\XeTeXinterchartoks 0 1{\xeCJK@@i}
\XeTeXinterchartoks 0 2{\xeCJK@@ii}
\XeTeXinterchartoks 0 3{\xeCJK@@iii}
\XeTeXinterchartoks 0 \xecjk@boundry{\xeCJK@@cclv}
...
\XeTeXinterchartoks 5 \xecjk@boundry{\xeCJK@v@cclv}
\XeTeXinterchartoks \xecjk@boundry 0{\xeCJK@cclv@}
\XeTeXinterchartoks \xecjk@boundry 1{\xeCJK@cclv@i}
\XeTeXinterchartoks \xecjk@boundry 2{\xeCJK@cclv@ii}
\XeTeXinterchartoks \xecjk@boundry 3{\xeCJK@cclv@iii}
\XeTeXinterchartoks \xecjk@boundry 4{\xeCJK@cclv@iv}
\XeTeXinterchartoks \xecjk@boundry 6{\xeCJK@cclv@vi}
...
\XeTeXinterchartoks 6 \xecjk@boundry{\xeCJK@vi@cclv}
\def\xeCJK@vi@i{
  \bgroup
  \xeCJK@emptyCJKtoks
  \xeCJK@setfont
...
\def\xeCJK@emptyCJKtoks{
  \XeTeXinterchartoks \xecjk@boundry 1{\relax}
  \XeTeXinterchartoks \xecjk@boundry 2{\relax}
  \XeTeXinterchartoks \xecjk@boundry 3{\relax}}
\def\xeCJK@@cclv{

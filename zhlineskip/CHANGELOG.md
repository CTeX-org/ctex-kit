## [zhlineskip-v1.0h](https://github.com/CTeX-org/releases/tag/zhlineskip-v1.0h)

- 文档等宽字体改用朱雀仿宋，意大利体改用霞鹜文楷 GB Lite。

## [zhlineskip-v1.0g](https://github.com/CTeX-org/releases/tag/zhlineskip-v1.0g)

- 添加 `quiet` 选项用于削弱警告信息。

## [zhlineskip-v1.0f](https://github.com/CTeX-org/releases/tag/zhlineskip-v1.0f)
...
## [zhlineskip-v1.0e](https://github.com/CTeX-org/releases/tag/zhlineskip-v1.0e)

- 延迟正文行距调整。

## [zhlineskip-v1.0d](https://github.com/CTeX-org/releases/tag/zhlineskip-v1.0d)

- 增加警告描述。

## [zhlineskip-v1.0c](https://github.com/CTeX-org/releases/tag/zhlineskip-v1.0c)

- 对未知的键值选项与无效的用户命令报错。

## [zhlineskip-v1.0b](https://github.com/CTeX-org/releases/tag/zhlineskip-v1.0b)

- 新增选项 `MSWordSinglespaceRatio`。

## [zhlineskip-v1.0a](https://github.com/CTeX-org/releases/tag/zhlineskip-v1.0a)

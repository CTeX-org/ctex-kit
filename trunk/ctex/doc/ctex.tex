...
\usepackage[c5size,fntef,hyperref,UTF8]{ctex}
\ifxetex\else
\usepackage{CJKspace}
\fi
...
\begin{table}[htbp]
\centering
\begin{tabular}{l>{\ttfamily}lp{.5\textwidth}} \hline
  类别 & \textnormal{文件} & 说明 \\ \hline
  文档类 & ctexart.cls & \texttt{article} 文档类的中文化版本 \\
         & ctexrep.cls & \texttt{report} 文档类的中文化版本 \\
         & ctexbook.cls & \texttt{book} 文档类的中文化版本 \\ \hline
  格式   & ctexcap.sty & 提供全部功能，但\textbf{默认不修改缺省字体大小}，
         ...
         & ctex.sty    & 提供全部功能，但\textbf{默认不开启章节标题设置功能}，
                         ...
                         需要使用 |cs4size| 或 |c5size| 选项来修改，适用于非标准文档类 \\ \hline
\end{tabular}
...
处于与旧版本兼容性的考虑，我们保留了 |\CTEXnumber| 和 |\CTEXdigits|。
...
\item Qing Lee（\email{sobenlee@gmail.com}）
